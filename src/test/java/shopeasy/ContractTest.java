...
class ContractTest {
    ...
    //  Positive tests: should run without any errors 
    ...
    void applyDiscount_validInput_shouldNotThrow() {
        ...
        assertThatCode(() -> cart.applyDiscount(15.0)).doesNotThrowAnyException();
    }
    ...
    //  Negative tests: must throw an AssertionError 

    // Testing addItem rules
    @Test
    ...
    @Test
    void applyDiscount_rateOver100_shouldViolatePreCondition() {
        assertThatThrownBy(() -> cart.applyDiscount(150.0))
                .isInstanceOf(AssertionError.class);
    }

    // Testing PriceCalculator rules
    @Test
    void calculate_negativeBasePrice_shouldViolatePreCondition() {
        assertThatThrownBy(() -> calculator.calculate(-50.0, 10.0, 18.0))
                .isInstanceOf(AssertionError.class);
    }

    @Test
    void calculate_negativeDiscountRate_shouldViolatePreCondition() {
        assertThatThrownBy(() -> calculator.calculate(100.0, -5.0, 18.0))
                .isInstanceOf(AssertionError.class);
    }

    @Test
    void calculate_taxRateOver100_shouldViolatePreCondition() {
        assertThatThrownBy(() -> calculator.calculate(100.0, 10.0, 105.0))
                .isInstanceOf(AssertionError.class);
    }
}